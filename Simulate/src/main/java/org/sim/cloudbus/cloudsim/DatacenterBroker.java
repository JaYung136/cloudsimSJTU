...
import org.sim.cloudbus.cloudsim.lists.CloudletList;
...
public class DatacenterBroker extends SimEntity {
	...
	protected void createVmsInDatacenter(int datacenterId) {
		...
		Log.printLine("Datacenter Broker create vm");
		int requestedVms = 0;
		...
		if(requestedVms == 0) {
			sendNow(datacenterId, CloudSimTags.VM_CREATE_ACK, new Vm(-1, 0, 0.0, 0, 0, 0, 0, "0",new CloudletSchedulerTimeShared()));
		}
