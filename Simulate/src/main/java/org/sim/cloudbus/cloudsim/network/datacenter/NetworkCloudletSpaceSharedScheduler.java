...
package org.sim.cloudbus.cloudsim.network.datacenter;
...
public class NetworkCloudletSpaceSharedScheduler extends CloudletScheduler {
	...
	/*
	 * (non-Javadoc)
	 * @see CloudletScheduler# getTotalCurrentAvailableMipsForCloudlet
	...
	/*
	 * (non-Javadoc)
	 * @see CloudletScheduler# getTotalCurrentAllocatedMipsForCloudlet
	 * (ResCloudlet, double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see CloudletScheduler# getTotalCurrentRequestedMipsForCloudlet
	 * (ResCloudlet, double)
	 */
	@Override
