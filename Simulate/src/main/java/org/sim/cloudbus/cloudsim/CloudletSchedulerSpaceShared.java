...
public class CloudletSchedulerSpaceShared extends CloudletScheduler {
	...
	public double getCpuUtilization() {
		return usedPes / currentCpus;
	}

	@Override
	public double getRamUtilization() {
		return usedRam / currentRam;
	}
	 ...
	 */
	@Override
	public double updateVmProcessing(double currentTime, List<Double> mipsShare, double ramShare) {
		...
		//Log.printLine("Cloudlet's size: " + getCloudletExecList().size());
	...
	/*
	 * (non-Javadoc)
	 * @see CloudletScheduler#getCurrentRequestedMips()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * CloudletScheduler#getTotalCurrentAvailableMipsForCloudlet(org.cloudbus
	 ...
	 * (non-Javadoc)
	 * @see
	 * CloudletScheduler#getTotalCurrentAllocatedMipsForCloudlet(org.cloudbus
	 ...
	 * (non-Javadoc)
	 * @see
	 * CloudletScheduler#getTotalCurrentRequestedMipsForCloudlet(org.cloudbus
	 * .cloudsim.ResCloudlet, double)
	 */
	@Override
